                        ...
                        <div class="card-body">
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    $sql = "SELECT dk.*, d.nama as nama_dosen, k.tempat
                                    ...
                                    JOIN kegiatan k ON dk.kegiatan_id = k.id";
                                        ...
                                        <td>{$row['tempat']}</td>
                                        <td>
                                            <a href='edit.php?dosen_id={$row['dosen_id']}&kegiatan_id={$row['kegiatan_id']}' class='btn btn-sm btn-warning'>Edit</a>
                                            <a href='hapus.php?dosen_id={$row['dosen_id']}&kegiatan_id={$row['kegiatan_id']}' class='btn btn-danger btn-sm' onclick=\"return confirm('Hapus relasi ini?');\">Hapus</a>
                                        </td>
                                    </tr>";
                                    }
                                    ?>
