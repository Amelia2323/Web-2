<?php
                                ...
                                $id = $_GET['id'];
                                $data = $dbh->query("SELECT * FROM penelitian WHERE id = $id")->fetch();
                                ...
                                if ($_SERVER["REQUEST_METHOD"] == "POST") {
                                    ...
                                    $stmt->execute([$judul, $mulai, $akhir, $tahun, $bidang, $id]);
...
<nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand--> 
        <a class="navbar-brand ps-3" href="admin/index.php">Penelitian</a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    ...
                    <h2 class="mt-4">Edit Penelitian</h2>
                    <div class="card mb-4">
                        ...
                        <div class="card-body">
                            <div class="container-fluid px-4">
                                ...
                                <form method="post">
                                    <div class="mb-3">
                                        <label>Judul</label>
                                        <textarea name="judul" class="form-control"><?= $data['judul'] ?></textarea>
                                    </div>
                                    <div class="mb-3">
                                        <label>Mulai</label>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <select name="bidang_ilmu_id" class="form-control">
                                            ...
                                            foreach ($bidang as $b) {
                                                $selected = $b['id'] == $data['bidang_ilmu_id'] ? 'selected' : '';
