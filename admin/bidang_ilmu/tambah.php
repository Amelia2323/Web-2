...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $stmt = $dbh->prepare("INSERT INTO bidang_ilmu (nama, deskripsi) VALUES (?, ?)");
    $stmt->execute([$nama, $deskripsi]);

    header("Location: index.php");
    exit; // penting agar kode tidak lanjut
}
?>
<!DOCTYPE html>
<html lang="en">
...
<body class="sb-nav-fixed">
    <nav class="sb-topnav navbar navbar-expand navbar-dark bg-dark">
        <!-- Navbar Brand-->
        <a class="navbar-brand ps-3" href="admin/index.php">Bidang Ilmu</a>
        <!-- Sidebar Toggle-->
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid px-4">
                    <h1 class="mt-4">Data Bidang Ilmu</h1>
                    <ol class="breadcrumb mb-4">
                        <li class="breadcrumb-item"><a href="index.php"></a>Dashboard</li>
                        <li class="breadcrumb-item active">Bidang Ilmu</li>
                    </ol>
                    
                    <h2 class="mt-4">Tambah Bidang Ilmu</h2>
                    <div class="card mb-4">
                        <div class="card-header"><i class="fas fa-table me-1"></i>Data Bidang Ilmu</div>
                        <div class="container-fluid px-4">
                            <form method="POST">
                                <div class="mb-3">
